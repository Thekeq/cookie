...
#
# Меньше ITEM_PAYBACK_HOURS, но того же порядка: слияние ОБЯЗАНО остаться
# выгоднее прямой покупки — в этом весь смысл мердж-цикла, — но в 1.7 раза, а не
# в девяносто. Значение подобрано перебором по balance_sim --matrix: оно даёт
# лучшую долю доски в коридоре при наименьшем промахе по кривой уровней.
MERGE_PAYBACK_HOURS = 7.0
...
#
# ТЕМП РОСТА — главное в этой таблице. Доход доски удваивается за тир, тиры
# открываются каждые 1-2 уровня, поэтому ферма обязана удваиваться тем же
# темпом. Девять зданий с шагом x4 через 3-5 уровней этого не держали: до 20
# уровня ферма забирала 95% дохода, после 26 — отдавала 80% доске. Здесь 16
# зданий, ровно по одному на каждые два уровня, с шагом cps около x3 — при
# такой сетке доля доски держится в коридоре 11-69% на всей лестнице (пила
# внутри коридора — это ритм: новое здание вырывается вперёд, следующий тир
# доски отыгрывает).
#
...
FARM_BUILDINGS = {
    ...
    "conveyor":    {"base_cost": 20_363,         "cps": 12.8,         "req_level": 6},
    "factory":     {"base_cost": 68_129,         "cps": 38.1,         "req_level": 8},
    "mine":        {"base_cost": 225_317,        "cps": 113.8,        "req_level": 10,
                    "req_record": 8},
    "shipment":    {"base_cost": 738_161,        "cps": 339.9,        "req_level": 12,
                    "req_record": 9},
    "reactor":     {"base_cost": 2_399_388,      "cps": 1_015.0,      "req_level": 14,
                    "req_record": 10},
    "portal":      {"base_cost": 7_747_751,      "cps": 3_031.2,      "req_level": 16,
                    "req_record": 11},
    "cloud":       {"base_cost": 24_876_734,     "cps": 9_052.7,      "req_level": 18,
                    "req_record": 12},
    "timelab":     {"base_cost": 79_485_108,     "cps": 27_035.8,     "req_level": 20,
                    "req_record": 13},
    "moonbase":    {"base_cost": 252_884_382,    "cps": 80_742.1,     "req_level": 22,
                    "req_record": 15},
    "quantum":     {"base_cost": 801_536_093,    "cps": 241_136.0,    "req_level": 24,
                    "req_record": 17},
    "galaxy":      {"base_cost": 2_532_052_748,  "cps": 720_151.5,    "req_level": 26,
                    "req_record": 19},
    "singularity": {"base_cost": 7_974_903_227,  "cps": 2_150_729.0,  "req_level": 28,
                    "req_record": 21},
    "multiverse":  {"base_cost": 25_050_253_041, "cps": 6_423_141.8,  "req_level": 30,
                    "req_record": 23},
}
