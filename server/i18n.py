...
T: dict[str, dict[str, str]] = {
    ...
    # возврат по платежу, товар по которому так и не выдали: снимать нечего, и
    # говорить «бонус снят» нельзя — игрок пойдёт искать, чего лишился
    "pay_refunded_only": {
        "en": "↩️ Stars refunded. The item was never delivered, "
              "so there was nothing to remove.",
        "uk": "↩️ Зірки повернуто. Товар не було видано, тож знімати нічого.",
        "ru": "↩️ Звёзды возвращены. Товар не был выдан, снимать нечего.",
    },
    # ---------- пуши ----------
    "notif_streak": {
