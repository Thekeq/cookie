...
const dict = {
  ...
  b_conveyor: { en: 'Conveyor', uk: 'Конвеєр', ru: 'Конвейер' },
  b_factory: { en: 'Factory', uk: 'Фабрика', ru: 'Фабрика' },
  b_mine: { en: 'Cookie Mine', uk: 'Шахта печива', ru: 'Печенечная шахта' },
  b_shipment: { en: 'Shipment', uk: 'Вантажівка', ru: 'Грузоперевозки' },
  b_reactor: { en: 'Reactor', uk: 'Реактор', ru: 'Реактор' },
  b_portal: { en: 'Portal', uk: 'Портал', ru: 'Портал' },
  b_cloud: { en: 'Cloud Bakery', uk: 'Хмарна пекарня', ru: 'Облачная пекарня' },
  b_timelab: { en: 'Time Lab', uk: 'Лабораторія часу', ru: 'Лаборатория времени' },
  b_moonbase: { en: 'Moon Base', uk: 'Місячна база', ru: 'Лунная база' },
  b_quantum: { en: 'Quantum Oven', uk: 'Квантова піч', ru: 'Квантовая печь' },
  b_galaxy: { en: 'Galaxy Farm', uk: 'Галактична ферма', ru: 'Галактическая ферма' },
  b_singularity: { en: 'Singularity', uk: 'Сингулярність', ru: 'Сингулярность' },
  b_multiverse: { en: 'Multiverse', uk: 'Мультивсесвіт', ru: 'Мультивселенная' },
